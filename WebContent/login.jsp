...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="logincheck.jsp" method="post">
...
<form action="testrole.jsp" method="post">
  <table align="center">
  <tr>
  <td>
  <input type="radio" name="role" value="doctor"></td><td>  Doctor<br></td>
  </tr>
  <tr>
  <td>
<input type="radio" name="role" value="user"></td><td> User<br></td>
</tr>
</table>
  <br>
  <input type="submit"  class="remodal-confirm" value="OK">
  <input type="submit"  class="remodal-cancel" value="Cancel">
  </form>
</div>
