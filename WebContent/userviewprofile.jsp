...
<%
	...
	ResultSet rs;
	rs = st.executeQuery("select * from user_reg where email='" + useremail + "'");
	while(rs.next()){
                    ...
                    <form method="POST" class="register-form" id="register-form">
                        ...
                        <div class="form-group">
                            ...
                            <br><br>
                                ...
                                <input type="text" name="father_name" id="father_name" value="<%= rs.getString("age") %>" readonly required/>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <input type="text" name="address" id="address" value="<%= rs.getString("phoneno") %>" readonly required/>
                        </div>
						<br>
						<div class="form-group">
                        ...
                        <div class="form-submit">
                           <a href="userEditableprofile.jsp">
